...
export function MobileFrame({ children }: { children: ReactNode }) {
  return (
    <div
      className="w-full flex lg:items-center lg:justify-center font-sans relative overflow-hidden"
      style={{ 
        minHeight: "100vh",
    ...
    >
      ...
      <div className="hidden lg:block absolute top-[-15%] left-[-10%] w-[55%] h-[55%] rounded-full bg-primary/18 blur-[160px] pointer-events-none" />
      <div className="hidden lg:block absolute bottom-[-20%] right-[-15%] w-[55%] h-[55%] rounded-full bg-accent/8 blur-[180px] pointer-events-none" />

      <motion.div
        initial={{ opacity: 0, y: 16, scale: 0.98 }}
        animate={{ opacity: 1, y: 0, scale: 1 }}
        transition={{ duration: 0.7, ease: [0.16, 1, 0.3, 1] }}
        className="relative w-full lg:max-w-[430px] lg:rounded-[3rem] overflow-hidden flex flex-col
                   lg:border-[10px] lg:border-[hsl(24_30%_8%)]
                   lg:shadow-[0_60px_140px_-30px_hsl(20_100%_4%/0.9),0_0_0_1px_hsl(30_20%_96%/0.07)]"
        style={{
      ...
      >
        ...
        <div className="hidden lg:flex absolute top-3 inset-x-0 h-9 z-[60] pointer-events-none justify-center">
        ...
        <div className="hidden lg:flex absolute bottom-2.5 inset-x-0 z-[60] pointer-events-none justify-center">
